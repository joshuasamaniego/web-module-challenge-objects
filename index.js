...
// OLD VERSION:
// function createMenuItem(itemName, cost, itemCategory) {
//   const updateMenu = {
//     name: itemName,
//     price: cost,
...
console.log(createMenuItem("Iced Tea", 3, "Drinks"));
...
console.log(createMenuItem("Reuben", 12, "Lunch"));
...
const burger = {
  ...
  discount: function (str) {
    if (str === "teacher" || str === "student") {
      ...
      return "Invalid Input. Please type: 'teacher', 'student' or 'public' for results.";
    }
  },
};
...
//   rating: 4,
//   feedback:
//     "This place has a great atmosphere. I love to come here and study. Food is a little pricy though.",
// };
// review.push(newRating);
reviews.push({
  name: "Joshua",
  rating: 4,
  feedback:
